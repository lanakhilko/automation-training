...
public class MainPageObject {
    ...
    public boolean isElementLocatedOnScreen(String locator){
        ...
        int element_location_by_y = this.waitForElementPresent(locator, "Can't find element by locator for isElementOnScreen method", 5).getLocation().getY();
        int screen_size_by_y = driver.manage().window().getSize().getHeight();
        return element_location_by_y < screen_size_by_y;
    }

    public void clickDeleteElementInRightUpperCorner(String locator, String error_message){
